...
extern void asm_handle_eint0_3(void);
extern void asm_handle_eint4_11(void);

void do_eint0_3(void)
{
	if(EINT0PEND & 0x1){
		if(GPNDAT & 0x1)
			gpmdat = 0xf;
...
void int_init(void)
{
	...
	EINT0MASK &= ~(0x3f);
	VIC0INTENABLE |= (0x3);
	VIC0VECTADDR0 = asm_handle_eint0_3;
	VIC0VECTADDR1 = asm_handle_eint4_11;
}
